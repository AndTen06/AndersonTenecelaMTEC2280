    ...
    delay(500);
     ...
     if (ButtonValue != 0) {
      ...
      int value = map(potRead, 0, 255, 1, 20);
        ...
        tone(piezoPin, 800 * value, 900);
        tone(piezoPin, 350 * value, 670);
        tone(piezoPin, 200 * value, 500);
        tone(piezoPin, 100 * value, 300);
        tone(piezoPin, 400 * value, 600);
        tone(piezoPin, 550 * value, 300);
        tone(piezoPin, 500 * value, 800);
        tone(piezoPin, 300 * value, 500);
        tone(piezoPin, 700 * value, 950);
        tone(piezoPin, 1050 * value, 1100);
